...
const NAME = 'Variant Beaufort Cipher Decode';

class VariantBeaufortCipherDecode extends CustomOperation {
  constructor() {
    super();
    this.name = NAME;
    this.description = 'Decodes the Variant Beaufort cipher: P = (C + K) mod 26.';
...
registerCustomOp(VariantBeaufortCipherDecode, {
  name: NAME,
  module: 'Custom',
  description: 'Variant Beaufort cipher decode — P = (C + K) mod 26.',
...
export default VariantBeaufortCipherDecode;
